...
export function AgentOrb({ state, size = 120 }: AgentOrbProps) {
	...
	const leftEyeVariants = {
		...
		working: { height: 9, width: 24, rotate: 0, borderRadius: "6px 6px 6px 6px", backgroundColor: "#00ff41" }, 
		sneaky: { height: 27, width: 18, rotate: -5, borderRadius: "12px 12px 12px 12px", backgroundColor: "#fff" },
		success: { height: blink ? 2 : 33, width: 24, rotate: 15, borderRadius: "15px 15px 15px 15px", backgroundColor: "#00ff41" },
