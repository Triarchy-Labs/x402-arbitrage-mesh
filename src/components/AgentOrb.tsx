...
export function AgentOrb({ state, size = 120 }: AgentOrbProps) {
	...
	const leftEyeVariants = {
		...
		working: { height: 9, width: 24, rotate: -10, borderRadius: "6px 6px 6px 6px", backgroundColor: "#00ff41" }, 
		sneaky: { height: 27, width: 18, rotate: -5, borderRadius: "12px 12px 12px 12px", backgroundColor: "#fff" },
		success: { height: blink ? 2 : 27, width: 27, rotate: 0, borderRadius: "20px 20px 6px 6px", backgroundColor: "#00ff41" },
